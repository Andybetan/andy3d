const translations = {
  en: {
    ...
    hero: {
      ...
      collageCardAlt2: 'Fezandipiti ex Pokémon Trading Card Game listing',
      printTapHint: 'Tap the figure for print details',
      closePrintDetail: 'Close',
      tcgColumnHint: 'Listed on Cardmarket · AndyBetan',
      tcgFanAria: 'Pokémon cards — hover or tap to fan them open',
      tcgFlipBackAria: 'Fezandipiti — tap to bring this card to the front',
      tcgFlipFrontAria: 'Piplup — tap to show this card on top',
      cardTitle: 'Mimikyu',
  ...
  es: {
    ...
    hero: {
      ...
      collageCaption: 'Misma mesa: pieza impresa y cartas reales en venta.',
      collageCardAlt: 'Ejemplo de carta Pokémon TCG en venta',
      collageCardAlt2: 'Carta Fezandipiti ex Pokémon TCG en venta',
      printTapHint: 'Toca la figura para ver datos de impresión',
      closePrintDetail: 'Cerrar',
      tcgColumnHint: 'En venta en Cardmarket · AndyBetan',
      tcgFanAria: 'Cartas Pokémon — pasa el ratón o toca para abrir el abanico',
      tcgFlipBackAria: 'Fezandipiti — toca para poner esta carta encima',
      tcgFlipFrontAria: 'Piplup — toca para dejar esta carta encima',
    },
    fusion: {
