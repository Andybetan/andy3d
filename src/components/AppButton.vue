...
defineProps({
  variant: {
    type: String,
    default: 'primary', // primary | secondary | outline | amber
  },
  size: {
    type: String,
    default: 'md', // sm | md | lg
  ...
  <component
    ...
    :class="[
      ...
      'hover:scale-[1.02] active:scale-[0.98]',
      {
        ...
        'bg-transparent text-amber-400 border-2 border-amber-400/55 hover:bg-amber-400/10 hover:border-amber-400 hover:text-amber-300': variant === 'amber',
      },
      {
